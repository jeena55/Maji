...
<body>
  ...
  <?php
    ...
    $ordersDeliverySQL = "SELECT  
                                    ...
                                    WHERE o.orderId = $orderId && (o.deliveryId IS NOT NULL OR o.takeawayId IS NOT NULL)
                                    ";
    ...
    if ($ordersDeliveryResult->num_rows > 0) {
      ...
      //table orders
      $orderStatus = $ordersDetailRow['orderStatus'];
    ...
    <?php if ($orderStatus === 'ยกเลิกออเดอร์') {
          echo "<p class='text-2xl text-red-600 hover:text-red-400 text-center'> - ยกเลิกคำสั่งซื้อแล้ว - </p>";
        } else if ($orderStatus === 'เสร็จสิ้นออเดอร์') {
          echo "<p class='text-2xl text-green-600 hover:text-green-400 text-center'> - คำสั่งซื้อเสร็จสิ้นแล้ว - </p>";
        }
    ?>
